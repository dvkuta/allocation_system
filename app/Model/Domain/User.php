...
class User
{
    ...
    public static function createUser(UserDTO $userDTO): User
    {
        return new User($userDTO->getId(), $userDTO->getFirstname(), $userDTO->getLastname(),
            $userDTO->getEmail(), $userDTO->getLogin(), $userDTO->getWorkplace(), $userDTO->getPassword());
    }

    public function toDTO(): UserDTO
    {
        return new UserDTO($this->getId(), $this->getFirstname(), $this->getLastname(),
            $this->getEmail(), $this->getLogin(), $this->getWorkplace(), $this->getPassword());
    }
